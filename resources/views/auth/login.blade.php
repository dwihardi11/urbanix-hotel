...
<head>
    ...
    <title>Login - Urbanix Admin</title>
    ...
    <style>
        ...
        * {
        ...
        .form-check-input:focus {
            box-shadow: 0 0 0 0.25rem rgba(230, 198, 138, 0.25);
        }
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-brand">URBAN<span>IX</span></div>
            ...
            <div class="text-center mb-3">
                ...
                <a href="{{ route('register') }}" class="text-accent" style="font-weight: 600;"> Create Account</a>
            </div>
